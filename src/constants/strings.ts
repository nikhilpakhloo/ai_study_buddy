export const APP_STRINGS = {
  ...
  drawer: {
    ...
    newChatErrorMessage: "Please try again.",
  ...
  chat: {
    ...
    defaultConversationTitle: "My First Chat",
    ...
    sendErrorMessage: "Please check your connection and try again.",
    uploadAccessibilityLabel: "Upload a document",
    uploadErrorMessage: "Please choose a PDF file.",
